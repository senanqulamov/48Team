...
const BlogCard = ({ post, featured = false }: { post: BlogPost; featured?: boolean }) => {
  return (
    <motion.article
      ...
      className={`group relative overflow-hidden rounded-2xl bg-gray-900/50 backdrop-blur-sm border border-gray-800/50 hover:border-gray-700 transition-all duration-300 ${featured ? "md:col-span-2 lg:col-span-2" : ""}`}
    >
      <Link href={`/blogs/${post.slug}`} className="block">
        ...
        <div className="p-6">
          <div className="flex items-center gap-4 text-sm text-gray-400 mb-3">
            ...
            <h3
              className={`font-bold text-white mb-2 group-hover:text-emerald-400 transition-colors ${featured ? "text-2xl md:text-3xl" : "text-xl"}`}
            >
              {post.title}
            </h3>
            ...
            <div className="relative min-h-screen bg-black text-white">
              ...
              <section className="relative overflow-hidden md:overflow-visible pt-32 pb-16 px-4 sm:px-6 lg:px-8">
                ...
                <div className="max-w-6xl mx-auto">
                  ...
                  >
                    <h1 ref={titleRef} data-spotlight-target className="text-5xl md:text-7xl font-bold mb-6">
